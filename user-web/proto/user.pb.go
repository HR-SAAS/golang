...
var file_user_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x4b, 0x0a, 0x10,
	...
	0x28, 0x05, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x27, 0x0a, 0x0d, 0x4d, 0x6f, 0x62,
	...
	0x6c, 0x65, 0x22, 0x83, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x01, 0x28, 0x05, 0x52, 0x03, 0x73, 0x65, 0x78, 0x22, 0x99, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64,
	...
	0x72, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x65, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x03, 0x73, 0x65, 0x78, 0x22, 0x94, 0x01, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x73, 0x65, 0x78, 0x32, 0xac, 0x02, 0x0a, 0x04,
	...
	0x65, 0x12, 0x31, 0x0a, 0x10, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x4d,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x29, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x34, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73,
...
var file_user_proto_depIdxs = []int32{
	6, // 0: UserListResponse.data:type_name -> UserResponse
	0, // 1: User.GetUserList:input_type -> PageInfo
	3, // 2: User.FindUserByMobile:input_type -> MobileRequest
	1, // 3: User.FindUserById:input_type -> IdRequest
	4, // 4: User.CreateUser:input_type -> UserRequest
	5, // 5: User.UpdateUser:input_type -> UpdateUserRequest
	1, // 6: User.DeleteUserById:input_type -> IdRequest
	2, // 7: User.GetUserList:output_type -> UserListResponse
	6, // 8: User.FindUserByMobile:output_type -> UserResponse
	6, // 9: User.FindUserById:output_type -> UserResponse
	6, // 10: User.CreateUser:output_type -> UserResponse
	7, // 11: User.UpdateUser:output_type -> google.protobuf.Empty
	7, // 12: User.DeleteUserById:output_type -> google.protobuf.Empty
...
func (c *userClient) DeleteUserById(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (*UnimplementedUserServer) DeleteUserById(context.Context, *IdRequest) (*emptypb.Empty, error) {
...
func _User_DeleteUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).DeleteUserById(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
