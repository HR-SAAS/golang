...
type CompanyClient interface {
	...
	// 公司下所有用户,分页
	GetCompanyUserIdList(ctx context.Context, in *GetCompanyUserListRequest, opts ...grpc.CallOption) (*UserIdList, error)
	// 加入公司
...
func (c *companyClient) GetCompanyUserIdList(ctx context.Context, in *GetCompanyUserListRequest, opts ...grpc.CallOption) (*UserIdList, error) {
	out := new(UserIdList)
...
type CompanyServer interface {
	...
	// 公司下所有用户,分页
	GetCompanyUserIdList(context.Context, *GetCompanyUserListRequest) (*UserIdList, error)
	// 加入公司
...
func (UnimplementedCompanyServer) GetCompanyUserIdList(context.Context, *GetCompanyUserListRequest) (*UserIdList, error) {
