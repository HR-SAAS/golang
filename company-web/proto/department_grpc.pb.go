...
type DepartmentClient interface {
	...
	// 全部人员分页
	GetDepartmentUserIdList(ctx context.Context, in *GetDepartmentUserListRequest, opts ...grpc.CallOption) (*UserIdList, error)
	// 加入部门
...
func (c *departmentClient) GetDepartmentUserIdList(ctx context.Context, in *GetDepartmentUserListRequest, opts ...grpc.CallOption) (*UserIdList, error) {
	out := new(UserIdList)
...
type DepartmentServer interface {
	...
	// 全部人员分页
	GetDepartmentUserIdList(context.Context, *GetDepartmentUserListRequest) (*UserIdList, error)
	// 加入部门
...
func (UnimplementedDepartmentServer) GetDepartmentUserIdList(context.Context, *GetDepartmentUserListRequest) (*UserIdList, error) {
